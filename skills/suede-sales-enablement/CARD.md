...
Use when creating pitch decks, one-pagers, objection guides, demo scripts, talk tracks, battle cards, proposal structures, buyer cards, or deal-level ROI framing.

Out of scope — setting price or terms (use suede-pricing), building the offer (use suede-offers), sending outreach (use suede-cold-email), or publishing unsupported proof.
...
- Do not publish, send, present, or upload sales collateral without approval of the final audience, claims, and version.
- Do not invent customer quotes, logos, benchmarks, savings, integrations, or product capabilities; cite the source for each proof point and label modeled ROI.
- Do not decide pricing, contract terms, discounts, guarantees, or legal commitments. Route those decisions to their accountable owner.

## References

- Skill source: [`skills/suede-sales-enablement/SKILL.md`](./SKILL.md)
- Rendered reference page: <https://skills.suedeai.ai/skills/suede-sales-enablement.html>
