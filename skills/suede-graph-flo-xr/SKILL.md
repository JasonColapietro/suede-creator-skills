...
true at once, as in run `wf_c67e116f-f61`. Read the reason for what stopped
Select and that flag for what degraded the pool feeding it.
...
that cost two finalists still degraded a run that went on to ship.
