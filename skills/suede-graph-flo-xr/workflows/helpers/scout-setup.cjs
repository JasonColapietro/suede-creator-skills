...
const {spawnSync}=require("node:child_process");const {randomUUID}=require("node:crypto");const {mkdirSync,realpathSync}=require("node:fs");const {dirname,basename}=require("node:path"),parseStatus=value => {
