...
Current surface: 8 tools (`list_suede_skills`, `search_suede_skills`,
`get_suede_skill`, `suede_install_options`, `suede_copy_seo_audit`,
`suede_visibility_grade`, `suede_code_grade`, `suede_qa_checklist`),
6 resources (`suede://catalog`,
